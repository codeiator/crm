  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active">Verified Project</a></li>
      </ul>
      ...
      <br>
     <?php $rt=mysqli_query($con2,"SELECT u.name as name , u.contactNo as contact , project.created_at as date , project.title as title ,project.project_id as p_id from projects_add project ,users u where u.contactNo = project.username AND validated = 1 ");
...
if($num>0){
      ...
      <div class="row">
       ...
       <div class="col-md-12" style="background: #fff; padding: 10px; margin-bottom: 15px;">
         <h4 class="semi-bold"> <?php echo $row['title'] ?? "NA" ;?></h4>
