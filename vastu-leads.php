  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active">Vastu Leads</a></li>
      </ul>
        ...
        <div class="col-md-12">
          <div class="simple no-border" style="background: #fff;">
            <div class="grid-title no-border descriptive">
              <p style="font-size:15px;"> Name : <span class="text-success bold" style="text-transform: capitalize;"><?php echo $row['name'];?></span> &emsp;
