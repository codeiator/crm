  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active">Legal Help Leads</a></li>
      </ul>
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3>Legal Help Leads</h3>
      </div>
      <div class="clearfix"></div>
      
      <h4> <span class="semi-bold">Legal Help Leads</span></h4>
      <br>
     <?php $rt=mysqli_query($con2,"SELECT * from legal_help_leads");
        ...
        <div class="col-md-12">
          <div class="simple no-border" style="background: #fff;">
            <div class="grid-title no-border descriptive">
              <p style="font-size:15px;"> Name : <span class="text-success bold" style="text-transform: capitalize;"><?php echo $row['lead_name'];?></span> &emsp;
              Number :  <span class="text-success bold"><?php echo $row['lead_contact'];?></span> &emsp;
